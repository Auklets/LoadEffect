...
import { Panel, ListGroup, ListGroupItem, Table, Grid, Col, Well } from 'react-bootstrap';
  ...
  <Grid fluid>
    ...
    <Col sm={12}>
      <Panel className="scenario-documentation">
        ...
        <h3>Example</h3>
        <p>
          Here is an example of a script to sign up, log in, and create a couple of
          things in a one page app
        </p>
        <pre>
          {`
